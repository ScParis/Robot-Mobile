...
${START}                    COMEÇAR
${HAMNURGUER}               xpath=//android.widget.ImageButton[@content-desc="Open navigation drawer"]
...
Open Nav
    ...
    Wait Until Element Is Visible           ${HAMNURGUER}

    Click Element                            ${HAMNURGUER}
...
Go To Long Click
    ...
    Wait Until Page Contains              Botão clique long
